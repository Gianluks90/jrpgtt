# Elenco oggetti da implementare

**Simbolo Sacro**: (magico) Ignora bonus e malus alla fortuna in un luogo benedetto o maledetto. Puoi scegliere di non combattere un nemico spirito, distruggerlo e ottenere come ricompensa 1 exp.
...
**Lancia sacra**: (magico) Inutilizzabile da un personaggio malvagio. Forza +1. Forza +3 contro i Nemici Drago.
**Spada delle Rune**: (magico) Inutilizzabile da un personaggio buono. Forza +1. Quando vinci un combattimento usando questa arma recuperi 3% HP.
**Spada d'oro**: Forza +2. La spada si rompe se si viene sconfitti in un combattimento in cui è stata utilizzata.
**Corona del Mago**: (magico) Magia +2.
**Borsa di monete**: Contiene da 5 a 10 monete d'oro.
